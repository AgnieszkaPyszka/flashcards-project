# Dokument wymagań produktu (PRD) – Flashcards project

## 1. Przegląd produktu
Projekt Flashcards project ma na celu umożliwienie użytkownikom szybkiego tworzenia i zarządzania zestawami fiszek edukacyjnych. Aplikacja wykorzystuje modele LLM (poprzez API) do generowania sugestii fiszek na podstawie dostarczonego tekstu.
